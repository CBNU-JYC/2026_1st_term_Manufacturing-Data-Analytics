...
log_dir = BASE_DIR / "runs" / "fault_diagnosis_experiment"
...
sns.barplot(x=metrics_names, y=metrics_values, hue=metrics_names, yerr=None, ax=axes[1], palette='viridis', legend=False)
